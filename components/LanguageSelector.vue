<template>
  <div class="relative px-1 py-2 cursor-pointer">
    <div
      ...
      class="flex px-2 py-2 bg-gray-200 rounded"
      @click="showOptions"
    >
    ...
    <ul
      v-if="optionsShowed"
      class="absolute text-gray-700 pt-1 z-50 right-0 overflow-y-auto text-sm"
      style="margin-bottom: 96px; max-height: 355px"
    >
