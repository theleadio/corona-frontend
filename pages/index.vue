		...
		head() {
			...
			return {
				...
				meta: [
					...
					{ hid: 'og-image', property: 'og:image', content: process.env.API_BASE_URL + '/sharing/globalStatsToday' },
					{ hid: 'twitter-image', property: 'twitter-image', content: process.env.API_BASE_URL + '/sharing/globalStatsToday' }
				],
			};
		},
		components: {
