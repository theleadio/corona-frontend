  ...
  export default {
    ...
    methods: {
      async loadCountryTrendData(countryCode) {
        ...
        this.startDate = moment(this.countryTrend.trendDates[0]).format('Do MMM YYYY');
        this.endDate = moment(this.countryTrend.trendDates[this.countryTrend.trendDates.length-1]).format('Do MMM YYYY');
