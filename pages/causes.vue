<template>
  <main class="container">
    <div class="w-full h-screen">
      <h1 class="text-2xl font-bold mb-4">{{ $t('What is the 2019-nCov virus?') }}</h1>
      ...
      <iframe style="width:100%;height:100%" src="https://www.cdc.gov/coronavirus/2019-ncov/about/transmission.html"></iframe>
    </div>
  </main>
</template>
