export default {
	...
	"Source": "Nguồn",
	"and various international media": "và các phương tiện truyền thông quốc tế khác nhau",
	"Country": "Đất nước",
	"Full list here": "Toàn bộ danh sách",
	"Cases identified on a cruise ship currently in Japanese territorial waters.": "Các trường hợp được xác định trên một tàu du lịch hiện đang ở trong lãnh hải của Nhật Bản.",
	"Steps": "Các bước",
	"to prevent coronavirus": "Để ngăn chặn coronavirus",
	"Read and share this with others": "Đọc và chia sẻ điều này với những người khác",
	"Learn how": "Học cách",
	...
	"If you believe any of the source information above is inaccurate, please lodge a report using the following": "Nếu bạn tin rằng bất kỳ thông tin nguồn nào ở trên là không chính xác, vui lòng gửi báo cáo ",
	"form": "bằng mẫu",
