export default {
  ...
  "Live": "براہ راست",
  "Stats Overview": "اعدادوشمار کا جائزہ",
  "Global": "عالمی",
  "Confirmed": "تصدیق شدہ",
  "Recovered": "صحتیاب",
  "Deaths": "اموات",
  ...
  "Search": "تلاش",
  "Verified News": "تصدیق شدہ نيوز",
  "Clear All": "سب کچھ صاف کریں",
  "No result": "نتیجہ کچھ بھی نہیں ہے",
  "Prev": "پچھلا",
  "Next": "ااگلا",
  "Countries Affected": "متاثرہ ممالک",
  "Source": "ذریعہ",
  "and various international media": "اور مختلف بین الاقوامی میڈیا",
  "Country": "ملک",
  "Cases identified on a cruise ship currently in Japanese territorial waters.": "ایسے مریض جن کی شناخت کروز جہاز پر کی جاتی ہے جو جاپانی علاقائی پانی میں موجود ہے۔",
  "Full list here": "مکمل فہرست یہاں موجود ہے",
  "Steps": "اقدامات",
