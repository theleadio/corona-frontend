export default {
  ...
  country: "Bansa",
  cruise_ship_notice:
    "Dagito kaso nga na identify jiay cruise ship ket adda ijiay teritoryo ti Japan.",
  ...
  help_us_locations:
    "Tulungan dakami nga biruken ti lokasyan dita pagilyan yu.",
  ...
  update_resources:
    "I update mi daytoy nga page iti baro nga impormasyon panggep ti NCov prebention, para ti kanayon pay nga impormasyon click mo ditoy manipod ti",
  WHO: "WHO",
