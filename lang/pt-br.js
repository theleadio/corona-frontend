export default {
  ...
  "Total Recovered": "Total Curados",
  "Total Deaths": "Total Mortes",
  "Outbreak trend over time": "Evolução do surto ao longo do tempo",
  "Top countries with daily new cases": "Países com o maior número de novos casos diários",
  "Daily New Cases": "Novos Casos Diários",
  "Daily New Deaths": "Novas Mortes Diárias",
  ...
  "Team Public Relations": "Time de Relações Públicas",
  "View more": "Ver mais",

  "Fatality Rate": "Taxa de Mortalidade",
  "Positive Rate": "Taxa Positiva",
  "OF TOTAL CASES": "DO TOTAL DE CASOS",
  "Time taken from confirmation to discharge": "Tempo entre a confirmação e a alta",
  "{number} days": "{number} dias",
  "+{number} since yesterday": "+{number} desde ontem",
  "Daily Cases": "Casos Diários",
  "in ICU": "na UTI",
  "Daily Cases Receiving Treatment": "Casos Recebendo Tratamento Diariamente",
  "Daily Recovered Cases": "Casos Curados Diariamente",
  "of total cases": "do total de casos",
  "Past 30 Days Chart": "Gráfico dos Últimos 30 Dias",

  "COVID-19 Corona Tracker": "Rastreador de Corona COVID-19",
  "COVID-19 Corona Tracker: The only independent World Health Organization (WHO) recognized one stop platform for verified data and news.": "Rastreador de Corona COVID-19: A única plataforma centralizada reconhecida pela Organização Mundial de Saúde (OMS) para dados verificados e notícias.",
  "COVID-19 {country} Corona Tracker": "Rastreador de Corona COVID-19 {country}",
  "{country} COVID-19 Corona Tracker: The only independent World Health Organization (WHO) recognized one stop platform for verified data and news.": "Rastreador de Corona COVID-19 {country}: A única plataforma centralizada reconhecida pela Organização Mundial de Saúde (OMS) para dados verificados e notícias.",
  "COVID-19 related analytics, graphs, and charts": "Estatísticas e gráficos relacionados ao COVID-19",
  "Visual presentations of COVID-19 related data from verified sources such as WHO, CDC, ECDC, NHC of the PRC, JHU CSSE, DXY, QQ, and various international media.": "Apresentações visuais de dados relacionados ao COVID-19 de fontes verificadas tais como a OMS, CDC, ECDC, NHC da PRC, JHU CSSE, DXY, QQ, e várias mídias internacionais.",
};
